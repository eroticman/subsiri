					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">แก้ไขข้อมูลรถยนต์</h3>
			            </div>
			            <div class="panel-body container-fluid">
							...
							<div class="row">
				                ...
				                <div class="form-group col-lg-6" data-plugin="formMaterial">
				                ...
				                <div class="form-group col-lg-6" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">ขนาด</label>
				                  	<input type="text" class="form-control" id="product_size" name="product_size" value="<?php echo $product_detail->size; ?>">
				                </div>
								<div class="form-group col-lg-12" data-plugin="formMaterial">
									<label class="form-control-label" for="guarantee">รับประกัน</label>
