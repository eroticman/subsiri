			              	...
			              	<form id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
								...
								<div class="form-group" data-plugin="formMaterial">
									...
									<textarea class="form-control summernote" rows="4" placeholder="Detail" id="editor" name="description">
                                        <?php echo $about_us_detail->description; ?>
                                    </textarea>
								</div>
								<div class="form-group form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">รูปภาพ</label>
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../img/about_us/' . $about_us_detail->id . '/' . $about_us_detail->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
