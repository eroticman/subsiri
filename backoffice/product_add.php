			            ...
			            <div class="panel-body container-fluid">
			              	<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="urlname" name="urlname" placeholder="subsiri-product-name" required>
				                </div>
				                <div class="form-group" data-plugin="formMaterial">
				                ...
				                <div class="form-group" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="price">ขนาด</label>
				                  	<input type="text" class="form-control" id="product_size" name="product_size" placeholder="10x10 ซม.">
				                </div>
								<div class="form-group" data-plugin="formMaterial">
